$app_define$("@quickapp-kit/framework-v1", [], function ($app_require$, module, exports) {
  const createReactivePageVm = (function createReactivePageVm(target, context, bindings, blockDefinitions = {}) {
    let scheduled = false
    let revision = 0
    let sequence = 0
    const dirty = new Set()
